...
(function (window, undefined) {
    ...
    K.options = {
        ...
        htmlTags: {
            video : ['src', 'type', 'width','height','autoplay','loop','controls'],
            ...
            if (allowFlashUpload) {
                var uploadbutton = K.uploadbutton({
                    ...
                    afterUpload: function (data) {
                        dialog.hideLoading();
                        if (data.code === 0) {
                            var url = 'http://39.96.211.124/images/' + data.data.path;
                            if (formatUploadUrl) {
            ...
            var settings = {
                ...
                upload_success_handler: function (file, serverData) {
                    ...
                    var data = {
                        ...
                        url: 'http://39.96.211.124/images/' + serverData.data.path
                    }
